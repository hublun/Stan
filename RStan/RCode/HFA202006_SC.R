...
#================ compile stan model ========================================
remove(sm)
sm = stan_model("~/Dropbox/Stan/Models/HFA202006_SC.stan")
#======================== sampling ==========================================
remove(fit)
...
pairs(fit, pars=c("hfas","hfac"))
summary(fit)

plot(fit, 
     pars=names(fit)[c(4,5,13,36,40,48,59,61,66,70,84,87,99,100)], 
     show_density=FALSE,
     fill_color="#998811",
     est_color="#ffffff",
     ci_level=0.55, outer_level=0.9) + theme_Posterior
...
plot(fit, pars=c("HAs"), ci_level = 0.70, outer_level=0.90, 
     color="red",
     fill_color="#123489",
     est_color = "#ffffff",
