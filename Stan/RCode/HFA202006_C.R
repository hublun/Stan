...
#================ compile stan model ========================================
remove(sm)
sm = stan_model("~/Dropbox/Stan/Models/HFA202006_C.stan")
#======================== sampling ==========================================
remove(fit)
...
#========================== plot =======================================================
traceplot(fit, pars=c("hfac"))
pairs(fit, pars=c("hfas","hfac"))
summary(fit)

plot(fit, 
     pars=names(fit)[c(4,6,10,11,21,23,26,31,40, 43,45,46, 49,51, 52,
                       60,62,67,68,70,71,80,81,82,84,86,98)], 
     show_density=FALSE,
     fill_color="#998811",
     est_color="#ffffff",
     ci_level=0.7, outer_level=0.9) + theme_Posterior
