...
NLP740X222 <- read_csv("~/Dropbox/Stan/Data/NLP740X10.csv", col_names = FALSE)
...
#===================== Model =================================================
sfit = stan(
                file = paste(getwd(), "/Dropbox/Stan/Models/NLP741X10X1138PVU20191218.stan", sep=""),
                model_name = "NLP741X10X1138",
                data = dl,
                init = "random",
...
plot(sfit, pars = c(pnames[c(pl+beg)]), est_color="#123456", fill_color="#123456") + 
